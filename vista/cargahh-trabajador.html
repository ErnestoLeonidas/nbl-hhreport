...
<!-- CABECERA -->
<div>
            <!-- <a class="botonmenu" href="#" id="sidebarCollapse">
            <span class="glyphicon glyphicon-menu-hamburger icono"></span>
            </a> -->
    ...
    <!-- <div class="container-fluid">
        <div class="row">
            <div class="col-2" >
            <button class="botonmenu" id="sidebarCollapse"><span class="glyphicon glyphicon-menu-hamburger icono"></span></button>
     ...
     <div class="row cabecera">
        ...
        <div class="d-flex" style="position: fixed;right:0">                       
            <a href="../controlador/cerrar_sesion.php" class="botonlogout pt-1">
