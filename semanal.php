    ...
    <div class="col">
        <div class="card mt-2">
            <div class="card-header ">
                <div class="row">
                    <div class="col-6"><h4>Reporte de proyectos por usuarios</h4></div>
                </div>
            </div>

            <div class="ml-3">
                <p class="font-weight-bold"><h5>Seleccione rango de fecha:</h5></p>
            </div>
...
<script type="text/javascript" src="asset/js-prisma/reporteProyectoPersona.js"></script>
