...
<head>
    ...
    <title>NBL HH - Reporte Mensual</title>
</head>
<body>
    <!-- Bootstrap NavBar -->
    ...
    <div class="col">
        <div class="card mt-2">
            <div class="card-header ">
                <div class="row">
                    <div class="col-4"><h4>Reporte Mensual</h4></div>
                
                    <div class="col-4">
                        <div class="text-right">
                            <span id="UF_Actual" class="badge badge-warning font-weight-normal"></span>
                        </div>
                    </div>

                    <div class="col-4">   
                        <div class="btn-group" role="group">
                            <button type="button" id="modificarUFcombobox" class="btn btn-success" data-toggle="modal" data-target="#editarUF">
            ...
            <div class="card-body">
                ...
                <!-- formulario para buscar mes y año -->
                    <form class="form-inline">
                        ...
                        <p class="font-weight-bold"><h5>INICIO: </h5></p>
                        <div class="form-group mb-2 mr-4 ml-2">
                                <input id="fechaInicio" class="form-control" >
                        </div>

                        <p class="font-weight-bold"><h5>TERMINO: </h5></p>
                        <div class="form-group mb-2 mr-2 ml-2">
                                <input id="fechaTermino" class="form-control" >
                        </div>

                        <div class="form-group mb-2 ml-2">
                            <div class="btn btn-primary" id="buscarReporteMensual"><span class="glyphicon glyphicon-search"></div>
                        </div>
                    </form>
                ...
                <div class="row mr-2 ml-2 mt-2">
                        ...
                        <table id="tablaReporteMensual" class="table table-striped table-hover table-sm" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">HH Real</th>
                                    <th scope="col">Valor Individual</th>
                                    <th scope="col">HH NBL</th>
                                </tr>
                            </thead>
                            <tbody>
                                <!-- Carga el datatable -->
...
<!-- MODAL EDITAR UF -->
<div>
    <div class="modal fade" id="editarUF" tabindex="-1" role="dialog" aria-labelledby="editarUFLabel">
        <div class="modal-dialog">
            <div class="modal-content">

                <!-- HEADER DEL MODAL -->
                <div class="modal-header">
                    <h4 class="modal-title" id="editarUFLabel">Editar Valor UF</h4>
                ...
                <div class="container m-3 text-center">
                    <form class="form-inline">
                        ...
                        <p class="font-weight-bold"><h5>UF: </h5></p>
                        <div class="form-group mb-2 mr-4 ml-2">
                            <input id="nuevaUF" class="form-control" >
                        </div>

                        <div class="form-group mb-2 ml-2">
                            <div class="btn btn-primary" id="btnNuevaUF">Aceptar</div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript" src="asset/js-prisma/reporteMensual.js"></script>
